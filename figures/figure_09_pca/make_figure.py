...
OUTPUT = os.environ.get("ORT_FIGURE_OUTPUT", os.path.join(HERE, "figure_09_pca.pdf"))
...
# ---- Supplementary S4/S5 continent palette (saturated Set1) ----
...
# ---- Panel A: worldwide reference (S4/S5 colour plates + dots) ----
for c in conts:
...
# ---- Panels B & C: zooms with S4/S5 colour plates + reference dots + ORT ----
...
TREAT_LABEL = {"rescaled": "rescale12"}
